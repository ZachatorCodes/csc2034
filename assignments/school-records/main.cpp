...
int main(int, char**)
{
    ...
    Faculty* faculty1 = new Faculty("Dr. Brain", "789 University Ave", "555-987-6543", "dr.brain@email.com",
                                    "Room A101", 75000.0, "01-15-2020", "M/W/F 9:00 AM - 12:00 PM", Rank::Senior);
    Faculty* faculty2 =
        new Faculty("Professor Gigglefits", "321 College Blvd", "555-111-2222", "professor.gigglefits@email.com",
                    "Room B202", 95000.0, "08-20-2018", "T/Th 1:00 PM - 4:00 PM", Rank::Junior);

    // Create 2 staff members
    Staff* staff1 = new Staff("Bell Jingles", "456 Work Street", "555-234-5678", "ms.jingles@email.com", "Room C303",
                              60000.0, "03-10-2019", "Administrative Assistant");
    Staff* staff2 = new Staff("Michael Bichael", "789 Office Blvd", "555-345-6789", "mike.bike@email.com", "Room D404",
                              65000.0, "11-01-2017", "Department Head");
